...
export const wagmiConfig = createConfig({
  ...
  transports: {
    ...
    [arbitrum.id]: fallback([http('https://arb1.arbitrum.io/rpc')]),
    [bsc.id]: fallback([http('https://bsc-dataseed.binance.org')]),
  },
  ssr: true,
});
...
export const CERTIFICATE_CONTRACT_ADDRESS = '0xe24D106a05203D923640B26448D299d802B8b2ad' as const;
